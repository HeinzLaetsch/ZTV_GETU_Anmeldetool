...
public class WertungsrichterTableHeaderEventHandler implements IEventHandler {
	...
	public WertungsrichterTableHeaderEventHandler(Document doc, AnmeldeKontrolleDTO anmeldeKontrolle)
			throws IOException {
		this.doc = doc;

...
export const selectAllUser = createSelector(selectUserState, fromUser.selectAll);
export const selectAktiveUser = () => createSelector(selectAllUser, (user) => user.filter((user) => user.aktiv));
export const selectDirtyUser = () => createSelector(selectAllUser, (user) => user.filter((user) => user.dirty));
...
export const selectUserByBenutzername = (name: string) =>
  createSelector(selectAllUser, (user) => user.filter((user) => user.benutzername === name));

export const selectUserByName = (name: string) =>
  createSelector(selectAllUser, (user) => user.filter((user) => user.name === name));

...
export const anlassSummariesAdapter: EntityAdapter<IAnlassSummary> = createEntityAdapter<IAnlassSummary>({
...
*/
export type AnlassSummariesState = {} & EntityState<IAnlassSummary>

export const initialState: AnlassSummariesState = anlassSummariesAdapter.getInitialState();
